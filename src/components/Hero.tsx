    ...
    >
      ...
      <div className="relative z-10 max-w-7xl 2xl:max-w-[1536px] mx-auto px-4 sm:px-6 lg:px-8 w-full pt-20 xs:pt-24 sm:pt-28 lg:pt-16 xl:pt-20 pb-8 lg:pb-6 flex flex-col justify-start lg:justify-center">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 sm:gap-6 lg:gap-8 xl:gap-12 items-center">
          ...
          {/* Left Column: Interactive Category Tabs (Laptop/Desktop), Main Headline, Subtitle, Trust Cards & CTAs */}
          <div className="lg:col-span-6 xl:col-span-6 space-y-4 sm:space-y-5 lg:space-y-6 z-10">

            {/* Interactive Category Selector Pill Bar (Hidden on Mobile, Visible on Laptop & Desktop) */}
            <motion.div
              initial={{ opacity: 0, y: -10 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.4 }}
              className="hidden sm:inline-flex items-center gap-1 p-1.5 rounded-full bg-white/95 backdrop-blur-md border border-[#bde9ff] shadow-xs relative"
            >
